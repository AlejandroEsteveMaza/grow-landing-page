...
export const pricingPlans: readonly PricingPlan[] = [
  {
    ...
    features: [
      ...
      'Panel para gestionar textos e imágenes + capacitación incluida',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Panel para gestionar textos e imágenes + capacitación completa',
    ],
    cta: 'Quiero esta web',
    featured: true,
  },
...
export const maintenancePlans: readonly MaintenancePlan[] = [
  {
    ...
    excluded: [
      ...
      'Los trabajos adicionales se cotizan por separado',
    ],
  },
];
